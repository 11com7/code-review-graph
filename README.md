...
```bash
uv tool install "git+https://github.com/11com7/code-review-graph.git[embeddings]"          # Local vector embeddings (sentence-transformers)
uv tool install "git+https://github.com/11com7/code-review-graph.git[google-embeddings]"   # Google Gemini embeddings
uv tool install "git+https://github.com/11com7/code-review-graph.git[communities]"         # Community detection (igraph)
uv tool install "git+https://github.com/11com7/code-review-graph.git[enrichment]"          # Python call-resolution enrichment (Jedi)
uv tool install "git+https://github.com/11com7/code-review-graph.git[eval]"                # Evaluation benchmarks (matplotlib)
uv tool install "git+https://github.com/11com7/code-review-graph.git[wiki]"                # Wiki generation with LLM summaries (ollama)
uv tool install "git+https://github.com/11com7/code-review-graph.git[all]"                 # All optional dependencies
```
