...
def _extract_annotation_list(node, language: str | None = None) -> list[str]:
    ...
    * Rust: preceding ``attribute_item`` siblings (``#[test]`` etc.).
...
class CodeParser:
    ...
    def _extract_from_tree(
        ...
        for child in root.children:
            ...
            if node_type in class_types and self._extract_classes(
                ...
                _depth, jsx_class_collector=jsx_class_collector,
            ):
                continue
    ...
    def _extract_functions(
        ...
        deco_list: list[str] = _extract_annotation_list(child, language)
        if deco_list:
